...
public class SearchingNursingFrame extends SearchingFrame {

    public SearchingNursingFrame(String s) {
        super(s);
    }
   ...
   public void actionPerformed(ActionEvent e) {
         if (e.getSource() == SubmitButton) {
            if (!SearchKeyText.getText().equals("")) {
               ...
               Nursing x =  (Nursing)admin.Search(Integer.parseInt(SearchKeyText.getText()));
                if (x != null) {
